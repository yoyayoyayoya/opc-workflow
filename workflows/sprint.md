...
6. **主动研究先于编码**：写代码前必须先研究框架/库的能力边界（读文档、查源码），产出能力映射表。禁止跳过研究直接编码——AI 天生倾向"凑合自己写"，必须用 workflow 强制先研究再动手。
...
基于 capability-map.md 的研究结论，读取相关源代码，向用户展示：

- 要改哪些文件
- 怎么改（必须与能力映射表中确认的 API 一致，不得凭空假设）
- 写什么测试
- 预期结果
